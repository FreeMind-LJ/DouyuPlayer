package cc.dy.model.net
{
   ...
   import cc.dy.model.comment.CommentTimeDelayControl;
   ...
   import cc.dy.model.comment.newCommentTimeDelayControl;
   ...
   public class Client
   {
      ...
      private var mobileDelayTime:int;
      
      private var pcDelayTime:int;
      ...
      private var eServerProtolType_Setup:int = 1;
      
      private var eServerProtolType_Verify:int = 2;
      ...
      public function UserLogin(param1:String) : void
      {
         ...
         xx.sub_1(_loc3_,_loc4_,_loc10_,_loc6_,_loc7_,_loc8_,this.roomId,_loc5_,0,GlobalData.VERSION,GlobalData.SWF_VERSION);
         var _loc17_:int = CModule.malloc(4);
         var _loc18_:int = xx.sub_11(_loc11_.time,_loc17_);
         ...
         var _loc21_:int = xx.sub_2(_loc12_,_loc20_);
      ...
      public function KeepLive(param1:TimerEvent = null) : void
      {
         ...
         if(this._conn != null)
         {
            ...
            _loc8_ = xx.sub_4(_loc4_,GlobalData.byteCount,_loc7_);
      ...
      public function giveGift(param1:String) : void
      {
         ...
         var _loc9_:int = xx.sub_6(String(_loc3_),_loc4_,_loc5_,_loc8_);
      ...
      public function requestRewardList() : void
      {
         ...
         var _loc4_:int = xx.sub_8(int(Param.RoomId),Param.isShow == 1?1:0,_loc3_);
      ...
      private function ParseMsg(param1:TcpEvent) : void
      {
         ...
         if(_loc4_ == "loginres")
         {
            ...
            if(_loc5_ >= 2000)
            {
               _loc7_ = new Date().time / 1000;
               UserBehaviorLog.getInstance().sendChatLog(UserBehaviorLog.POINT_ID_LOGIN_SERVER,_loc7_,{
                  "id":Param.ServerIp + ":" + Param.ServerPort,
                  "lag":_loc5_
               });
            }
            _loc6_ = int(Math.random() * 200);
            if(_loc6_ == 0)
            {
               UserBehaviorLog.getInstance().addLog(UserBehaviorLog.POINT_ID_LOGIN_GATESERVER,{
                  "sid":Param.ServerIp + ":" + Param.ServerPort,
                  "req_time":Math.round(this.lst / 1000),
                  "resp_time":Math.round(new Date().time / 1000)
               });
            }
         ...
         else if(_loc4_ != "rdr")
         {
            if(_loc4_ != "scl")
            {
               ...
               {
                  EventCenter.dispatch("WorkRequestData",{
                     "type":"suq",
                     "str":_loc2_,
                     "pwd":this.pwdVar
                  });
      ...
      private function ServerLoginInfo(param1:String) : void
      {
         ...
         Param.isPs = npv;
         if(live_stat == 0 && (Param.Status || Param.IS_HOSTLIVE == 1 || Param.usergroupid == "5"))
         {
      ...
      public function reqOnlineGift() : void
      {
         ...
         if(GlobalData.isYouke != 0)
         {
            ...
            _loc4_ = xx.sub_7(this.my_uid,_loc3_);
      ...
      private function ServerChatContent(param1:Decode) : void
      {
         ...
         var _loc2_:int = param1.GetItemAsInt("ct");
         var _loc3_:int = param1.GetItemAsInt("sender");
         if(Param.p2pType != 0)
         {
            if(_loc2_ == 1 || _loc2_ == 2)
            {
               if(Param.mobileDelayTime > 0)
               {
                  new CommentTimeDelayControl(param1,this.my_uid,this.myblacklist,Param.mobileDelayTime);
                  return;
               }
            }
            else if(Param.isLoginUser == 0 || Param.isPs == 1)
            {
               if(Param.pcDelayTime > 0)
               {
                  new CommentTimeDelayControl(param1,this.my_uid,this.myblacklist,Param.pcDelayTime);
                  return;
               }
            }
         }
         var _loc4_:int = param1.GetItemAsInt("rescode");
         var _loc5_:int = param1.GetItemAsInt("time");
         var _loc6_:int = param1.GetItemAsInt("receiver");
         var _loc7_:String = param1.GetItem("content");
         var _loc8_:String = param1.GetItem("scope");
         var _loc9_:String = param1.GetItem("snick");
         var _loc10_:String = param1.GetItem("dnick");
         var _loc11_:int = param1.GetItemAsInt("cd");
         var _loc12_:String = param1.GetItem("sui");
         var _loc13_:String = param1.GetItem("chatmsgid");
         var _loc14_:int = param1.GetItemAsInt("maxl");
         var _loc15_:int = param1.GetItemAsInt("col");
         GlobalData.chatMaxChars = _loc14_;
         var _loc16_:Decode = new Decode();
         _loc16_.Parse(_loc12_);
         ...
         if(_loc4_ == 0)
         {
            ...
            _loc27_.AddItem_int("rescode",_loc4_);
            if(_loc3_)
            {
               _loc27_.AddItem("sender_nickname",_loc9_);
               _loc27_.AddItem_int("sender",_loc3_);
            }
            else
            {
               _loc27_.AddItem_int("sender",_loc3_);
            }
            _loc27_.AddItem_int("receiver",_loc6_);
            if(_loc6_ != 0)
            {
               _loc27_.AddItem("receiver_nickname",_loc10_);
            }
            else
            {
               _loc27_.AddItem("receiver_nickname","");
            }
            _loc27_.AddItem("content",_loc7_);
            _loc27_.AddItem_int("roomgroup",1);
            _loc27_.AddItem_int("cd",_loc11_);
            _loc27_.AddItem_int("sender_rg",_loc17_);
            _loc27_.AddItem_int("sender_pg",_loc18_);
            if(_loc8_ == "private")
            {
               _loc27_.AddItem("chatmsgid",_loc13_);
               _loc28_ = _loc27_.Get_SttString();
               $.asTojs("room_data_chatpri",_loc28_);
            }
            else
            {
               _loc27_.AddItem_int("time",_loc5_);
               _loc27_.AddItem_int("maxl",_loc14_);
               _loc27_.AddItem_int("m_deserve_lev",_loc19_);
               _loc27_.AddItem("chatmsgid",_loc13_);
               _loc27_.AddItem_int("cq_cnt",_loc20_);
               _loc27_.AddItem_int("col",_loc15_);
               _loc27_.AddItem_int("ct",_loc2_);
               ...
               {
                  _loc30_ = Util.facereplace(_loc7_);
                  if(_loc30_ != "")
                  {
                     _loc31_ = _loc3_ == this.my_uid?true:false;
                     if(_loc31_)
                     {
                     ...
                     if(_loc15_ == 0)
                     {
                        CommentTime.instance.start(new SingleCommentData(_loc30_,Util.getColor(_loc15_),GlobalData.textSizeValue,getTimer(),_loc31_,GlobalData.danmuModel));
                     }
                     else
                     {
         ...
         else if(_loc4_ == 289 || _loc4_ == 290 || _loc4_ == 294 || _loc4_ == 363)
         {
            _loc35_ = new Encode();
            _loc35_.AddItem("type","chatmessage");
            _loc35_.AddItem_int("rescode",_loc4_);
            if(_loc3_)
            {
               _loc35_.AddItem("sender_nickname",_loc9_);
               _loc35_.AddItem_int("sender",_loc3_);
            }
            else
            {
               _loc35_.AddItem_int("sender",_loc3_);
      ...
      private function newServerChatContent(param1:String) : void
      {
         ...
         var _loc2_:Decode = new Decode();
         _loc2_.Parse(param1);
         var _loc3_:int = _loc2_.GetItemAsInt("ct");
         if(Param.p2pType != 0)
         {
            if(_loc3_ == 1 || _loc3_ == 2)
            {
               if(Param.mobileDelayTime > 0)
               {
                  new newCommentTimeDelayControl(param1,this.my_uid,this.myblacklist,Param.mobileDelayTime);
                  return;
               }
            }
            else if(Param.isLoginUser == 0 || Param.isPs == 1)
            {
               if(Param.pcDelayTime > 0)
               {
                  new newCommentTimeDelayControl(param1,this.my_uid,this.myblacklist,Param.pcDelayTime);
                  return;
               }
            }
         }
         var _loc4_:int = _loc2_.GetItemAsInt("uid");
         var _loc5_:String = _loc2_.GetItem("txt");
         var _loc6_:int = _loc2_.GetItemAsInt("col");
         var _loc7_:String = _loc2_.GetItem("nn");
         var _loc8_:int = _loc2_.GetItemAsInt("cmt");
         var _loc9_:String = _loc2_.GetItem("ic");
         if(this.myblacklist.indexOf(_loc4_.toString()) == -1)
         {
            _loc10_ = Util.facereplace(_loc5_);
            if(_loc10_ != "")
            {
               _loc11_ = _loc4_ == this.my_uid?true:false;
               if(_loc11_)
               {
                  _loc12_ = new Date().time;
                  _loc13_ = _loc12_ - this.sendTime;
                  if(_loc13_ >= 1000)
                  {
                     _loc14_ = this.sendTime / 1000;
                     UserBehaviorLog.getInstance().sendChatLog(UserBehaviorLog.POINT_ID_CHAT_DELAY,_loc14_,{
                        "id":this.barrage_Conn.ip + ":" + this.barrage_Conn.port,
                        "lag":_loc13_
                     });
                  }
               ...
               if(_loc8_ == 3)
               {
                  MobileComentManager.instance.addComment({
                     "nn":_loc7_,
                     "txt":_loc10_,
                     "ic":_loc9_
                  });
               ...
               {
                  CommentTime.instance.start(new SingleCommentData(_loc10_,Util.getColor(_loc6_),GlobalData.textSizeValue,getTimer(),_loc11_,GlobalData.danmuModel));
               }
               else
               {
                  ColorComentManager.instance.addColorData({
      ...
      private function historyDanmuHandler(param1:String, param2:int) : void
      {
         var _loc8_:String = null;
         var _loc9_:Decode = null;
         var _loc10_:int = 0;
         var _loc11_:int = 0;
         var _loc12_:int = 0;
         $.jscall("console.log","history res 2 = " + param1);
         var _loc3_:Decode = new Decode();
         _loc3_.Parse(param1);
         var _loc4_:int = _loc3_.GetItemAsInt("ts_res");
         var _loc5_:String = _loc3_.GetItem("ocm");
         var _loc6_:Decode = new Decode();
         _loc6_.Parse(_loc5_);
         $.jscall("console.log","historychat length=" + _loc6_.count);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.count)
         {
            _loc8_ = _loc6_.GetItemByIndex(_loc7_);
            $.jscall("console.log","str1 = " + _loc8_);
            _loc9_ = new Decode();
            _loc9_.Parse(_loc8_);
            _loc10_ = _loc9_.GetItemAsInt("ts");
            _loc11_ = _loc4_ - _loc10_;
            _loc12_ = param2 - _loc11_;
            $.jscall("console.log","History  distanceTime = " + _loc11_ + "    ts=" + _loc10_ + "   cts=" + _loc4_ + "   delayPlayTime=" + _loc12_);
            if(_loc11_ > 0 && _loc12_ > 0)
            {
               new newCommentTimeDelayControl(_loc8_,this.my_uid,this.myblacklist,_loc12_);
            }
            _loc7_++;
         }
      }
      ...
      private function ServerKeepLive(param1:Decode) : void
      {
         ...
         $.asTojs("room_data_tbredpacket",param1.rawString);
         if(Param.isYinghun)
         {
      ...
      private function ServerRepeaterlist(param1:Decode) : void
      {
         ...
         if(_loc3_ != "")
         {
            ...
            this.barrage_Conn.historyDanmu = this.historyDanmuHandler;
      ...
      private function updateYC(param1:String) : void
      {
         var _loc2_:Decode = new Decode();
         _loc2_.Parse(param1);
         var _loc3_:Number = _loc2_.GetItemAsNumber("b");
         var _loc4_:Encode = new Encode();
      ...
      private function gu1(param1:String) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         xx.sub_19();
         xx.sub_18(this.pwdVar);
         var _loc2_:int = xx.sub_14(param1);
         if(this.eServerProtolType_Setup == _loc2_)
         {
            _loc3_ = CModule.malloc(4);
            _loc4_ = xx.sub_15(_loc3_);
            _loc5_ = CModule.read32(_loc3_);
            _loc6_ = CModule.readString(_loc5_,_loc4_);
            this._conn.sendmsg(_loc6_);
            $.jscall("console.log","xy =" + _loc6_);
            xx.sub_10(_loc3_);
            CModule.free(_loc3_);
         }
      }
      
      private function gu2(param1:String) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         ...
         var _loc2_:int = xx.sub_14(param1);
         if(this.eServerProtolType_Verify == _loc2_)
         {
            _loc3_ = CModule.malloc(4);
            _loc4_ = xx.sub_16(_loc3_);
            _loc5_ = CModule.read32(_loc3_);
            _loc6_ = CModule.readString(_loc5_,_loc4_);
            this._conn.sendmsg(_loc6_);
            $.jscall("console.log","yx =" + _loc6_);
            xx.sub_10(_loc3_);
            CModule.free(_loc3_);
         }
      }
      
      private function gu3(param1:String) : void
      {
         if(this._conn == null)
         {
            return;
         }
         var _loc2_:int = CModule.malloc(4);
         var _loc3_:int = xx.sub_17(param1,_loc2_);
         var _loc4_:int = CModule.read32(_loc2_);
         var _loc5_:String = CModule.readString(_loc4_,_loc3_);
         this._conn.sendmsg(_loc5_);
         $.jscall("console.log","xx =" + _loc5_);
         xx.sub_10(_loc2_);
         CModule.free(_loc2_);
      }
      
      public function guBak(param1:Object) : void
      {
         if(this._conn == null)
         {
            return;
         ...
         var _loc3_:String = param1.str;
         this._conn.sendmsg(_loc3_);
         $.jscall("console.log","xxx " + _loc2_ + " " + _loc3_);
      }
      
      private function room_data_cden(param1:String) : void
      {
         $.asTojs("room_data_cden",param1);
         $.jscall("console.log","color comment award notify");
      }
   }
}
