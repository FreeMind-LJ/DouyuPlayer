package cc.dy.model.net
{
   ...
   public class ClientBarrage
   {
      ...
      public var historyDanmu:Function;
      ...
      public function UserLogin() : void
      {
         ...
         var _loc6_:int = xx.sub_3(_loc1_,_loc5_);
      ...
      public function UserJoinGroup() : void
      {
         ...
         var _loc4_:int = xx.sub_5(this.roomId,this.my_gid,_loc3_);
         ...
         if(Param.p2pType != 0)
         {
            if(Param.isLoginUser == 0 || Param.isPs == 1)
            {
      ...
      private function ParseMsg(param1:TcpEvent) : void
      {
         ...
         else if(_loc4_ == "ocmres")
         {
            this.historyDanmuData(_loc2_);
         }
         else if(_loc4_ == "bcrp")
         {
            this.petInfo(_loc2_);
         ...
         {
            this.RefreshBurstLightNum(_loc2_);
         }
      }
      ...
      private function newServerKeepLive(param1:Decode) : void
      {
         ...
         var _loc2_:int = int(Math.random() * 200);
         if(_loc2_ == 0)
         {
            UserBehaviorLog.getInstance().addLog(UserBehaviorLog.POINT_ID_HEART_BEAT,{
               "sid":this.serverId,
               "req_time":Math.round(this._hbst / 1000),
      ...
      private function giftBroadcast(param1:String) : void
      {
         ...
         var _loc14_:String = _loc2_.GetItem("bid");
         var _loc15_:int = _loc2_.GetItemAsInt("sid");
         var _loc16_:int = _loc2_.GetItemAsInt("eid");
         ...
         $.jscall("console.log","live_gift_batter：",param1);
         if(_loc12_ == 1)
         {
            _loc17_ = _loc14_.split("_")[1];
            UserBehaviorLog.getInstance().addLog(UserBehaviorLog.POINT_ID_GET_ROCKET,{
               "sid":_loc15_,
               "drid":_loc7_,
               "gfid":_loc10_,
               "bgl":_loc13_,
      ...
      private function currentRoomGiftBroadcast(param1:String) : void
      {
         ...
         var _loc8_:int = 0;
         var _loc9_:Encode = null;
         var _loc2_:Decode = new Decode();
         _loc2_.Parse(param1);
         var _loc3_:int = _loc2_.GetItemAsInt("rid");
         var _loc4_:int = _loc2_.GetItemAsInt("gfid");
         var _loc5_:String = _loc2_.GetItem("nn");
         var _loc6_:String = _loc2_.GetItem("vt");
         if(_loc6_ != "")
         {
            EventCenter.dispatch("VotesChanged",{"vt":_loc6_});
         }
         if(Param.isYinghun)
         {
         ...
         if(GlobalData.giftBatterConfig == null)
         {
            if(GlobalData.OldModel)
            {
               GlobalData.giftBatterConfig = $.jscall("(function (){return window.giftBatterConfig})");
            }
            else
            {
               GlobalData.giftBatterConfig = $.jscall("(function (){return window.$ROOM.giftBatterConfig})");
            }
         }
         if(GlobalData.giftBatterConfig != null)
         {
            _loc7_ = GlobalData.giftBatterConfig[_loc4_.toString()];
            if(_loc7_ != null)
            {
               _loc8_ = _loc7_["ef"];
               if(_loc8_ == 3 || _loc8_ == 4 || _loc8_ == 5)
               {
                  _loc9_ = new Encode();
                  _loc9_.SttString = param1;
                  _loc9_.AddItem("imd","1");
                  $.asTojs("room_data_giftbat1",_loc9_.Get_SttString());
                  EventCenter.dispatch("YanzhiGiftMessageEvent",{
                     "eid":_loc7_["effect"],
                     "nn":_loc5_,
                     "gn":_loc7_["name"],
                     "ext":param1
      ...
      private function requestDanmu() : void
      {
         if(this._conn2 == null)
         {
            return;
         ...
         var _loc1_:Encode = new Encode();
         _loc1_.AddItem("type","ocmreq");
         _loc1_.AddItem_int("ts_range",Param.delayTime);
         var _loc2_:String = _loc1_.Get_SttString();
         this._conn2.sendmsg(_loc2_);
         $.jscall("console.log","history danmu req =" + _loc2_);
      }
      
      private function historyDanmuData(param1:String) : void
      {
         $.jscall("console.log","history danmu res = " + param1);
         this.historyDanmu(param1,Param.delayTime);
      }
      ...
      private function RefreshBurstLightNum(param1:String) : void
      {
         $.asTojs("RefreshBurstLightNum",param1);
         $.jscall("console.log","RefreshBurst" + param1);
      }
   }
}
