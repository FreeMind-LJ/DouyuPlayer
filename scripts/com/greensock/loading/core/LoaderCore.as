package com.greensock.loading.core
{
   ...
   public class LoaderCore extends EventDispatcher
   {
      ...
      public function LoaderCore(param1:Object = null)
      {
         ...
         this._cachedBytesTotal = "estimatedBytes" in this.vars?uint(uint(this.vars.estimatedBytes)):uint(LoaderMax.defaultEstimatedBytes);
         ...
         this._auditedSize = Boolean("estimatedBytes" in this.vars && this.vars.auditSize != true);
         this._rootLoader = !!this.vars.requireWithRoot?_rootLookup[this.vars.requireWithRoot]:_globalRootLoader;
      ...
      protected function _dump(param1:int = 0, param2:int = 0, param3:Boolean = false) : void
      {
         ...
         if(this._status == LoaderStatus.PAUSED && param2 != LoaderStatus.PAUSED)
         {
      ...
      protected function _errorHandler(param1:Event) : void
      {
         ...
         trace("Loading error on " + this.toString() + ": " + _loc3_);
