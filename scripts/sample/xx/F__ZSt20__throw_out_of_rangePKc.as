package sample.xx
{
   ...
   public function F__ZSt20__throw_out_of_rangePKc() : void
   {
      var _loc6_:* = 0;
      var _loc11_:int = 0;
      var _loc16_:* = 0;
      ...
      while(true)
      {
         ...
         if(_loc19_ == 0)
         {
            ...
            si32(-1,_loc15_);
            _loc3_ = _loc3_ - 16;
            si32(__ZNSt12out_of_rangeD1Ev,_loc3_ + 8);
            si32(__ZTISt12out_of_range,_loc3_ + 4);
            si32(_loc19_,_loc3_);
            ESP = _loc3_;
            F___cxa_throw();
            _loc3_ = _loc3_ + 16;
