package sample.xx
{
   ...
   public function F__ZSt21__throw_runtime_errorPKc() : void
   {
      var _loc6_:* = 0;
      var _loc11_:int = 0;
      var _loc16_:* = 0;
      ...
      while(true)
      {
         ...
         if(_loc19_ == 0)
         {
            ...
            si32(-1,_loc15_);
            _loc3_ = _loc3_ - 16;
            si32(__ZNSt13runtime_errorD1Ev,_loc3_ + 8);
            si32(__ZTISt13runtime_error,_loc3_ + 4);
            si32(_loc19_,_loc3_);
            ESP = _loc3_;
            F___cxa_throw();
            _loc3_ = _loc3_ + 16;
