package sample.xx
{
   ...
   public function F___floatunsisf() : void
   {
      ...
      if(_loc1_ != 0)
      {
         ...
         _loc8_ = 31 - (int(_loc10_ >>> 24));
         if(_loc8_ <= 23)
         {
            _loc10_ = _loc1_ << int(23 - _loc8_);
            _loc7_ = _loc10_ ^ 8388608;
         }
         else
         {
            _loc6_ = _loc1_ << int(55 - _loc8_);
            _loc5_ = 1;
            if(uint(_loc6_) <= 2147483648)
            {
               _loc5_ = 0;
            }
            _loc10_ = int(_loc8_ + -23);
            _loc1_ = int(_loc1_ >>> _loc10_);
            _loc10_ = _loc1_ ^ 8388608;
            _loc5_ = _loc5_ & 1;
            _loc7_ = int(_loc5_ + _loc10_);
            if(_loc6_ == -2147483648)
            {
               _loc10_ = int(_loc5_ + _loc1_);
               _loc10_ = _loc10_ & 1;
               _loc7_ = int(_loc10_ + _loc7_);
            }
         }
         _loc10_ = _loc8_ << 23;
         _loc10_ = int(_loc10_ + _loc7_);
         _loc10_ = int(_loc10_ + 1065353216);
