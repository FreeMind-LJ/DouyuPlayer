package sample.xx
{
   ...
   public function F___mulodi4() : void
   {
      ...
      {
         _loc12_ = _loc13_ | _loc14_ ^ -2147483648;
         if(_loc12_ == 0)
         {
            _loc14_ = 1;
            if(uint(_loc15_) >= 2)
         ...
         else
         {
            ...
            _loc12_ = _loc9_ ^ _loc16_;
            _loc12_ = int(_loc12_ - _loc9_);
            _loc16_ = int(_loc12_ - _loc5_);
            _loc5_ = _loc1_;
            if(_loc16_ >= 0)
            {
               _loc5_ = 0;
            ...
            if(_loc6_ == 0)
            {
               ...
               if(_loc7_ == 0)
               {
                  _loc12_ = _loc9_ ^ _loc5_ | _loc9_ ^ _loc5_;
                  if(_loc12_ == 0)
                  {
                     _loc2_ = int(_loc2_ - 16);
