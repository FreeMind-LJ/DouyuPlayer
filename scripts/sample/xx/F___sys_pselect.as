package sample.xx
{
   ...
   public function F___sys_pselect() : void
   {
      var _loc3_:* = 0;
      var _loc1_:int = 0;
      var _loc2_:* = int(ESP);
      ...
      var _loc7_:* = li32(_loc3_ + 20);
      var _loc5_:* = li32(_loc3_ + 16);
      var _loc4_:* = li32(_loc3_ + 12);
      _loc8_ = li32(_loc3_ + 8);
      _loc9_ = li32(_loc3_ + 4);
      ESP = _loc2_ & -16;
      _loc10_ = int(CModule.kernel.pselect(li32(_loc3_),_loc9_,_loc8_,_loc4_,_loc5_,_loc7_,_loc1_));
      eax = _loc10_;
      _loc2_ = _loc3_;
      ESP = _loc2_;
   }
