package sample.xx
{
   ...
   public function F___sys_sched_get_priority_max() : void
   {
      var _loc3_:* = 0;
      var _loc1_:int = 0;
      var _loc2_:* = int(ESP);
      ...
      if(_loc7_ == 0)
      {
         ...
         si32(0,_loc3_ - 24);
         si32(0,_loc3_ - 32);
         si32(___sys_sched_get_priority_max,_loc3_ - 32);
         si32(_loc7_,_loc5_);
         si32(4,_loc3_ - 24);
      ...
      ESP = _loc2_ & -16;
      _loc7_ = int(CModule.kernel.sched_get_priority_max(li32(_loc3_),_loc1_));
      eax = _loc7_;
      _loc2_ = _loc3_;
      ESP = _loc2_;
   }
