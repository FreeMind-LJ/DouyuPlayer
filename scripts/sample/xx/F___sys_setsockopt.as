package sample.xx
{
   ...
   public function F___sys_setsockopt() : void
   {
      var _loc3_:* = 0;
      var _loc1_:int = 0;
      var _loc2_:* = int(ESP);
      ...
      if(_loc9_ == 0)
      {
         ...
         si32(0,_loc3_ - 24);
         si32(0,_loc3_ - 32);
         si32(___sys_setsockopt,_loc3_ - 32);
         si32(_loc9_,_loc8_);
         si32(20,_loc3_ - 24);
      ...
      ESP = _loc2_ & -16;
      _loc9_ = int(CModule.kernel.setsockopt(li32(_loc3_),_loc8_,_loc7_,_loc4_,_loc6_,_loc1_));
      eax = _loc9_;
      _loc2_ = _loc3_;
      ESP = _loc2_;
   }
