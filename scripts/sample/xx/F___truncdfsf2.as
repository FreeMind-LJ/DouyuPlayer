package sample.xx
{
   ...
   public function F___truncdfsf2() : void
   {
      ...
      _loc2_ = _loc2_ | 4;
      _loc10_ = li32(_loc2_);
      _loc9_ = _loc10_ & 2147483647;
      _loc8_ = int(_loc9_ + -1206910976);
      _loc2_ = int(_loc9_ + -940572672);
      _loc7_ = li32(_loc4_);
      if(uint(_loc2_) < uint(_loc8_))
      {
         _loc9_ = int(_loc7_ >>> 29) | _loc10_ << 3;
         _loc7_ = _loc7_ & 536870911;
         if(uint(_loc7_) >= 268435457)
         {
            _loc6_ = int(_loc9_ + 1073741825);
         }
         else
         {
            _loc6_ = int(_loc9_ + 1073741824);
            if((_loc7_ ^ 268435456 | 0) == 0)
            {
               _loc6_ = int((_loc6_ & 1) + _loc6_);
            }
         }
      }
      else
