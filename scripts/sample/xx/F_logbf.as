package sample.xx
{
   ...
   public function F_logbf() : void
   {
      ...
      _loc9_ = _loc1_ & 2147483647;
      if(_loc9_ == 0)
      {
         si32(_loc9_,_loc6_ - 12);
         var _loc5_:* = -1;
         var _loc8_:* = Number(_loc5_ / lf32(_loc6_ - 12));
         _loc2_ = _loc8_;
      }
      ...
      {
         var _loc4_:* = 33554432;
         _loc8_ = Number(_loc2_ * _loc4_);
         sf32(_loc8_,_loc6_ - 8);
         _loc2_ = Number(int((int(li32(_loc6_ - 8) >>> 23) & 255) + -152));
      }
      else
      {
         _loc2_ = Number(int((int(_loc9_ >>> 23)) + -127));
      }
      st0 = _loc2_;
      _loc3_ = _loc6_;
      ESP = _loc3_;
