package sample.xx
{
   ...
   public function F_modf() : void
   {
      ...
      if(_loc9_ <= 19)
      {
         ...
         {
            _loc9_ = 1048575 >>> _loc9_;
            if((_loc9_ & _loc11_ | _loc6_) == 0)
            {
               sf64(_loc7_,_loc8_);
               si32(_loc11_ & -2147483648,int(_loc3_ - 48) | 4);
               si32(0,_loc3_ - 48);
            ...
            {
               si32(0,_loc8_);
               var _loc5_:* = int(_loc3_ - 40);
               _loc5_ = _loc5_ | 4;
               si32(_loc11_ & (_loc9_ ^ -1),_loc5_);
               si32(_loc11_ & (_loc9_ ^ -1),_loc8_ + 4);
               si32(0,_loc3_ - 40);
               _loc7_ = Number(_loc7_ - lf64(_loc3_ - 40));
            }
         }
      }
      else if(_loc9_ >= 52)
      {
         ...
         if(_loc9_ == 1024)
         {
            _loc7_ = Number(0 / _loc7_);
         }
         else
         {
            si32(_loc11_ & -2147483648,int(_loc3_ - 32) | 4);
            si32(0,_loc3_ - 32);
      ...
      {
         _loc9_ = -1 >>> int(_loc10_ + -1043);
         if((_loc9_ & _loc6_) == 0)
         {
            sf64(_loc7_,_loc8_);
            si32(_loc11_ & -2147483648,int(_loc3_ - 24) | 4);
            si32(0,_loc3_ - 24);
