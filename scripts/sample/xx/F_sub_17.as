   ...
   public function F_sub_17() : void
   {
      ...
      while(true)
      {
         ...
         if(_loc3_ == 0)
         {
            ...
            si32(_loc4_,_loc2_);
            ESP = _loc2_;
            F__ZN12CHashProcess17ProcessServerDataEPcPi();
            _loc2_ = int(_loc2_ + 16);
            _loc9_ = eax;
         ...
         while(true)
         {
            ...
            _loc11_ = li32(_loc1_ - 48);
            _loc12_ = li32(_loc1_ - 44);
            _loc3_ = li32(_loc1_ - 60);
            _loc2_ = int(_loc2_ - 16);
            si32(_loc3_,_loc2_);
            ESP = _loc2_;
