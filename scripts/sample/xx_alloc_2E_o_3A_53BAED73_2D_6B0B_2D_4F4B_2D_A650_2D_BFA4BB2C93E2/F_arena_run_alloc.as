   ...
   public function F_arena_run_alloc() : void
   {
      ...
      while(true)
      {
         ...
         if(_loc5_ != 0)
         {
            ...
            _loc8_ = int(_loc5_ - (int(_loc1_ + 16)));
            _loc8_ = int(uint(_loc8_) / 12);
            _loc8_ = _loc8_ << 12;
            _loc16_ = int(_loc8_ + _loc1_);
         ...
         else
         {
            ...
            if(_loc9_ != 0)
            {
               ...
               if(_loc9_ != 0)
               {
                  ...
                  si32(_loc3_,_loc2_ + 8);
                  si32(_loc15_,_loc2_);
                  _loc16_ = int((li32(_arena_chunk_header_npages) << 12) + _loc9_);
                  si32(_loc16_,_loc2_ + 4);
                  ESP = _loc2_;
                  F_arena_run_split();
                  _loc2_ = int(_loc2_ + 32);
