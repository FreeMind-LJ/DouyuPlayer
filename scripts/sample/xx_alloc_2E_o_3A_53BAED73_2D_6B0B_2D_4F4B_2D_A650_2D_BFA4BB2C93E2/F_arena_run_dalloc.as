package sample.xx_alloc_2E_o_3A_53BAED73_2D_6B0B_2D_4F4B_2D_A650_2D_BFA4BB2C93E2
{
   ...
   public function F_arena_run_dalloc() : void
   {
      ...
      _loc4_ = _loc4_ ^ -1;
      _loc20_ = li32(_loc8_ + 4);
      _loc19_ = _loc20_ & _loc4_;
      _loc18_ = int(_loc20_ - _loc19_);
      _loc17_ = int(_loc18_ >>> 12);
      _loc16_ = int(_loc17_ * 12);
      _loc15_ = int(_loc19_ + _loc16_);
      _loc14_ = li32(_loc15_ + 24);
      _loc4_ = _loc14_ & 2;
      ...
      if(_loc13_ == 0)
      {
         if(_loc20_ != 0)
         {
            _loc4_ = int(_loc18_ >>> 12);
            _loc4_ = int(_loc4_ * 12);
            _loc4_ = int(_loc4_ + _loc19_);
            _loc13_ = int(_loc4_ + 24);
            _loc18_ = int(_loc14_ >>> 12);
            do
            {
               _loc4_ = li32(_loc13_);
               _loc4_ = _loc4_ & -4;
      ...
      else
      {
         ...
         if(_loc18_ == 0)
         {
            ...
            _loc10_ = int(_loc8_ - 32);
            si32(_loc9_,_loc10_ | 4);
            _loc11_ = int(_loc1_ + 8);
            _loc4_ = _loc11_ & -2;
            ...
            while(true)
            {
               ...
               while(true)
               {
                  if(_loc11_ == _loc2_)
                  {
                     ...
                     _loc4_ = _loc11_ | 1;
                     si32(_loc4_,_loc19_ + 8);
                     if(_loc12_ >= 1)
                     {
                        _loc4_ = li32(_loc18_ + 8);
                        _loc4_ = _loc4_ & 1;
                        _loc4_ = _loc4_ | _loc19_;
                        si32(_loc4_,_loc18_ + 8);
                        _loc2_ = _loc19_ & -2;
                        _loc4_ = _loc4_ & 1 | li32(_loc2_ + 4);
                        si32(_loc4_,_loc18_ + 8);
                        si32(_loc18_,_loc2_ + 4);
                        _loc4_ = li32(_loc18_ + 8);
                        var _loc5_:* = li32(_loc2_ + 8);
                        _loc5_ = _loc5_ & -2;
                        _loc4_ = _loc5_ | _loc4_ & 1;
                  ...
                  else
                  {
                     ...
                     if(_loc4_ != 0)
                     {
                        ...
                        if(_loc4_ != 0)
                        {
                           ...
                           _loc5_ = _loc5_ & -2;
                           si32(_loc5_,_loc4_ + 8);
                           _loc4_ = li32(_loc18_ + 4);
                           if(_loc4_ == _loc2_)
                           {
                              si32(_loc9_,_loc18_ + 4);
                              _loc2_ = _loc9_;
                              break;
                           }
                           _loc4_ = li32(_loc18_ + 8);
         ...
         _loc4_ = int(_loc18_ + _loc20_);
         si32(_loc4_,_loc19_ + 12);
         _loc4_ = li32(_loc1_ + 40);
         _loc4_ = int(_loc4_ + _loc20_);
         si32(_loc4_,_loc1_ + 40);
      }
      _loc4_ = li32(_loc15_ + 24);
      _loc4_ = _loc4_ & 4095;
      _loc4_ = _loc4_ | _loc14_;
      si32(_loc4_,_loc15_ + 24);
      _loc4_ = int(_loc20_ + _loc17_);
      _loc20_ = int(_loc4_ * 12);
      _loc5_ = int(_loc20_ + _loc19_);
      var _loc6_:* = li32(_loc5_ + 12);
      _loc6_ = _loc6_ & 4095;
      ...
      {
         _loc4_ = int(_loc19_ + _loc20_);
         _loc18_ = li32(_loc4_ + 24);
         _loc4_ = _loc18_ & 1;
         if(_loc4_ == 0)
         {
            _loc3_ = int(_loc3_ - 16);
            _loc4_ = int(_loc1_ + 44);
            si32(_loc4_,_loc3_);
            _loc4_ = int(_loc19_ + 16);
            _loc5_ = int(_loc4_ + _loc20_);
            ...
            _loc3_ = int(_loc3_ + 16);
            _loc5_ = li32(_loc15_ + 24);
            _loc5_ = _loc5_ & 4095;
            _loc5_ = _loc5_ | _loc14_;
            si32(_loc5_,_loc15_ + 24);
            _loc5_ = int(_loc17_ + (int(_loc14_ >>> 12)));
      ...
      if(uint(_loc17_) > uint(_loc4_))
      {
         ...
         if(_loc4_ == 0)
         {
            ...
            _loc4_ = int(_loc1_ + 44);
            si32(_loc4_,_loc3_);
            _loc17_ = int(_loc17_ - (int(_loc15_ >>> 12)));
            _loc5_ = int(_loc19_ + 16);
            _loc6_ = int(_loc5_ + int(_loc17_ * 12));
            si32(_loc6_,_loc3_ + 4);
            _loc4_ = _loc15_ & -4096;
            _loc4_ = int(_loc4_ + _loc14_);
            ESP = _loc3_;
            F_arena_avail_tree_remove();
            _loc3_ = int(_loc3_ + 16);
            var _loc7_:* = li32(_loc6_ + 8);
            _loc7_ = _loc7_ & 4095;
            _loc7_ = _loc7_ | _loc4_;
            si32(_loc7_,_loc6_ + 8);
            _loc6_ = int(_loc17_ + (int(_loc4_ >>> 12)));
      ...
      _loc3_ = int(_loc3_ + 16);
      _loc16_ = li32(_arena_chunk_header_npages);
      _loc5_ = int(_loc16_ * 12);
      ...
      if(_loc5_ == _loc4_)
      {
         ...
         if(_loc17_ != 0)
         {
            ...
            if(_loc4_ != 0)
            {
               ...
               _loc4_ = int(li32(_loc19_) + 4);
               si32(_loc4_,_loc3_);
               ESP = _loc3_;
               F_arena_chunk_tree_dirty_remove();
               _loc3_ = int(_loc3_ + 16);
               _loc17_ = li32(_loc1_ + 36);
               _loc4_ = int(li32(_loc1_ + 40) - li32(_loc17_ + 12));
               si32(_loc4_,_loc1_ + 40);
            }
         ...
         _loc3_ = int(_loc3_ - 16);
         si32(_loc15_,_loc3_);
         _loc4_ = int(_loc16_ * 12);
         _loc4_ = int(_loc19_ + _loc4_);
      ...
      _loc17_ = li32(_opt_dirty_max);
      _loc19_ = li32(_loc1_ + 40);
      if(uint(_loc19_) > uint(_loc17_))
      {
         if(uint(_loc19_) > uint(int(_loc17_ >>> 1)))
         {
            _loc19_ = int(_loc1_ + 8);
            _loc17_ = int(_loc1_ + 4);
            loop4:
            do
            {
               ...
               _loc20_ = li32(_chunk_npages);
               while(true)
               {
                  _loc14_ = _loc20_;
                  _loc4_ = li32(_loc15_ + 12);
                  if(_loc4_ != 0)
                  {
                     _loc20_ = int(_loc14_ + -1);
                     _loc16_ = int(_loc15_ + int(_loc14_ * 12));
                     _loc18_ = li32(_loc16_ + 12);
                     _loc4_ = _loc18_ & 8;
                     if(_loc4_ != 0)
                     {
                        _loc4_ = _loc18_ ^ 8;
                        si32(_loc4_,_loc16_ + 12);
                        _loc13_ = int(_loc14_ + -1);
                        _loc2_ = 0;
                        _loc11_ = 4096;
                        while(true)
                        {
                           _loc5_ = int(_loc13_ + _loc2_);
                           _loc4_ = li32(_arena_chunk_header_npages);
                           if(uint(_loc5_) > uint(_loc4_))
                           {
                              _loc4_ = int(_loc2_ * 3);
                              _loc18_ = int(_loc16_ + (_loc4_ << 2));
                        ...
                        si32(5,_loc3_ + 8);
                        _loc4_ = _loc14_ << 12;
                        _loc4_ = int(_loc15_ + _loc4_);
                        si32(_loc11_,_loc3_ + 4);
                        _loc4_ = int(_loc4_ - _loc11_);
                        si32(_loc4_,_loc3_);
                        _loc4_ = int(_loc14_ + _loc2_);
                        _loc20_ = int(_loc4_ + -1);
                        ESP = _loc3_;
                        F_madvise();
                        _loc3_ = int(_loc3_ + 16);
                        _loc14_ = li32(_loc1_ + 40);
                        _loc16_ = li32(_opt_dirty_max);
            ...
            while(_loc4_ = int(_loc16_ >>> 1), uint(_loc14_) > uint(_loc4_));
